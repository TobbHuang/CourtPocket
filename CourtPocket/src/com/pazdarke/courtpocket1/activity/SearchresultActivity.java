...
import com.pazdarke.courtpocket1.activity.CourtlistActivity.RequestEachCourtThread;
import com.pazdarke.courtpocket1.activity.MycardActivity.AddFootviewHandler;
...
public class SearchresultActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv_leftarrow = (ImageView) findViewById(R.id.iv_searchresult_leftarrow);
		iv_leftarrow.setOnClickListener(onClickListener);
		
		TextView tv_title=(TextView)findViewById(R.id.tv_searchresult_title);
		tv_title.setText("“"+getIntent().getExtras().getString("GymName")+"”搜索结果");

		ImageView iv_location = (ImageView) findViewById(R.id.iv_searchresult_map);
		iv_location.setOnClickListener(onClickListener);
		
		/*rl_sportsspinner=(RelativeLayout)findViewById(R.id.rl_courtlist_sportsspinner);
		...
		mPullToRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_searchresult_list);
		...
		footView=getLayoutInflater().inflate(R.layout.layout_courtlist_footview, null);  	
		lv_list.addFooterView(footView);
		...
		tv_locationtitle=(TextView)findViewById(R.id.tv_searchresult_locationtitle);
		tv_location = (AlwaysMarqueeTextView) findViewById(R.id.tv_searchresult_location);
		iv_refresh = (ImageView) findViewById(R.id.iv_searchresult_refresh);
	...
	void init_list() {
		...
		adapter = new CourtlistAdapter(SearchresultActivity.this, mylist,
				R.layout.item_court, new String[] { "courtlogo", "courtname",
						"star", "price", "location", "meters", "service1",
		...
		lv_list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				try {
					intent.putExtra("ID", gymID.getInt("GymID"+(position-1))+"");
	...
	OnClickListener onClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			switch (v.getId()) {
			case R.id.iv_searchresult_leftarrow:
				finish();
				break;
			case R.id.iv_searchresult_refresh:
	...
	void init_spinner_sports() {
		...
		spinner_sports = (Spinner) findViewById(R.id.sp_searchresult_sports);
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
			...
			public View getDropDownView(int position, View convertView,
				...
				switch (position) {
				case 0:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
				...
				case 4:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
							.getDrawable(R.drawable.ic_courtlist_tabletennis2)
							: getResources().getDrawable(
									R.drawable.ic_courtlist_tabletennis1));
					break;
				case 5:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
				...
				case 7:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
							...
							: getResources().getDrawable(
									R.drawable.ic_courtlist_billiards1));
					break;
				case 8:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
				...
				case 9:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
							...
							: getResources().getDrawable(
									R.drawable.ic_courtlist_bodybuilding1));
					break;
				case 10:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
							.getDrawable(R.drawable.ic_courtlist_xgames2)
							: getResources().getDrawable(
									R.drawable.ic_courtlist_xgames1));
					break;
				case 11:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
							.getDrawable(R.drawable.ic_courtlist_golf2)
							: getResources().getDrawable(
									R.drawable.ic_courtlist_golf1));
					break;
				case 12:
					icon.setImageDrawable(spinner_sports.getSelectedItemPosition() == position ? getResources()
							.getDrawable(R.drawable.ic_courtlist_moresports2)
							: getResources().getDrawable(
									R.drawable.ic_courtlist_moresports1));
					break;
				}
		...
		spinner_sports.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
		...
		spinner_sports.setSelection(this.getIntent().getIntExtra("sports", 0));
	...
	void init_spinner_location() {
		...
		spinner_location = (Spinner) findViewById(R.id.sp_searchresult_location);
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				R.layout.layout_courtlist_spinner,R.id.tv_spinnerlayout, list){
			@Override
			public View getDropDownView(int position, View convertView,
				...
				ImageView icon = (ImageView) convertView
						.findViewById(R.id.iv_courtlistitem);
				icon.setImageDrawable(spinner_location.getSelectedItemPosition() == position ? getResources()
		...
		spinner_location.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> parent, View view,
					int position, long id) {
				// TODO Auto-generated method stub
				if(!firstLaunched2){
	...
	void init_spinner_order() {
		...
		spinner_order = (Spinner) findViewById(R.id.sp_searchresult_order);
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,
				R.layout.layout_courtlist_spinner,R.id.tv_spinnerlayout, list){
			@SuppressLint("NewApi")
			@Override
			public View getDropDownView(int position, View convertView,
				...
				switch (position) {
				case 0:
					icon.setImageDrawable(spinner_order.getSelectedItemPosition() == position ? getResources()
		...
		spinner_order.setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
			public void onItemSelected(AdapterView<?> parent, View view,
					int position, long id) {
				// TODO Auto-generated method stub
				if(!firstLaunched3){
	...
	void init_gif() {
		...
		gif_loading.setShowDimension((int)(Data.SCREENWIDTH*0.19), (int)(Data.SCREENHEIGHT*0.2));
		gif_loading.setGifImageType(GifImageType.SYNC_DECODER);

		rl_gifcontainer = (RelativeLayout) findViewById(R.id.rl_searchresult_gifcontainer);
		LayoutParams p = new LayoutParams((int)(Data.SCREENWIDTH*0.19), (int)(Data.SCREENHEIGHT*0.2));
	...
	public void run() {
		...
		System.out.println(locationTime+"error?");
	...
	public void onLocationChanged(AMapLocation location) {
		...
		System.out.println(locationTime+"success?");
		...
		if (location != null) {
			...
			if(!Data.ISTRUELOCATION){
				...
				if(locationTime>1){
					Toast.makeText(SearchresultActivity.this, "定位成功，可下拉刷新列表",
	...
	Runnable r_RequestList=new Runnable() {
		...
		public void run() {
			...
			params.add(new BasicNameValuePair("Request", "RequestListByName"));
			params.add(new BasicNameValuePair("Type", spinner_sports
			...
			params.add(new BasicNameValuePair("GymName",
					SearchresultActivity.this.getIntent().getExtras()
							.getString("GymName")));
			
			try {
				
				String result = new HttpPostConnection("GymInfoServer",
	...
	class TimeoutHandler extends Handler{
		...
		public void handleMessage(Message msg) {
			...
			Toast.makeText(SearchresultActivity.this, "连接服务器超时，请检查您的网络设置", Toast.LENGTH_SHORT).show();
			rl_gifcontainer.setVisibility(View.GONE);
			mPullToRefreshListView.onRefreshComplete();
		}
	}
	...
	class CloseGifHandler extends Handler{
		...
		public void handleMessage(Message msg) {
			...
			super.handleMessage(msg);
			lv_list.removeFooterView(footView);
			Toast.makeText(SearchresultActivity.this, "没有找到对应场馆~>_<~+", Toast.LENGTH_SHORT).show();
			rl_gifcontainer.setVisibility(View.GONE);
			mPullToRefreshListView.onRefreshComplete();
		}
	}
