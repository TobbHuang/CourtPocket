...
import com.pazdarke.courtpocket1.tools.listview.FightrecordAdapter;
...
public class FightrecordActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_fightrecord);
		...
		ImageView iv_leftarrow = (ImageView) findViewById(R.id.iv_fightrecord_leftarrow);
		iv_leftarrow.setOnClickListener(onClickListener);
		
		tv_error=(TextView)findViewById(R.id.tv_fightrecord_error);
		
		TextView tv_teamname=(TextView)findViewById(R.id.tv_fightrecord_teamname);
		tv_teamname.setText(intent.getStringExtra("TeamName"));

		mPullToRefreshListView = (PullToRefreshListView) findViewById(R.id.lv_fightrecord_list);
	...
	private void init_spinner() {
		...
		Spinner mSpinner = (Spinner) findViewById(R.id.sp_fightrecord);
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(
				FightrecordActivity.this, R.layout.layout_mybill_spinner,
	...
	OnClickListener onClickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			switch (v.getId()) {
			case R.id.iv_fightrecord_leftarrow:
				finish();
				break;
			}
		}
	...
	void init_list() {
		adapter = new FightrecordAdapter(FightrecordActivity.this, mylist,
				R.layout.item_fight);
	...
	void init_gif() {
		...
		rl_gifcontainer = (RelativeLayout) findViewById(R.id.rl_fightrecord_gifcontainer);
	...
	Runnable r_GetBillID = new Runnable() {
		...
		public void run() {
			...
			params.add(new BasicNameValuePair("Request", "TeamFight"));
			params.add(new BasicNameValuePair("TeamID",
					FightrecordActivity.this.getIntent().getStringExtra(
							"TeamID")));
			...
			if (loadNum >= b.getInt("num")) {
				for (int j = 0; j < b.getInt("num"); j++) {
					try {
						...
						map.put("isMyTeam", intent.getBooleanExtra("isMyTeam", false));
	...
	class TimeoutHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			Toast.makeText(FightrecordActivity.this, b.getString("result"),
